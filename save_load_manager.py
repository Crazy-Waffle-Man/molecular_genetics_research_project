...
class save_load_system:
    ...
    def __init__(self, file_extension, save_folder):
        """
        Args:
            file_extension: str (e.g: .png, .txt, or whatever else you want)
            save_folder: str
        """
    ...
    def check_for_file(self, name):
        """
        Args:
            name: str, the filename to check for.
        """
    ...
    def load_game_data(self, files_to_load, default_data):
        """
        Args:
            files_to_load: list, what filenames to check for.
            default_data: list, indicates what to load if the filename is not found.
        """
        variables = []
    ...
    def save_game_data(self, data_to_save, file_names):
        """
        Args:
            data_to_save: list, the values which will be stored. Each value must have a filename at the corresponding index in file_names.
            file_names: list, the filenames under which the data is stored.
        """
